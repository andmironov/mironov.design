...
},{"d3-array":1,"d3-collection":5,"d3-format":14,"d3-interpolate":17,"d3-time":27,"d3-time-format":26}],34:[function(require,module,exports){
/**
...
},{"./Debouncer":39,"lodash.assign":34,"lodash.clone":35,"lodash.foreach":36,"lodash.isempty":37,"lodash.isequal":38}],41:[function(require,module,exports){
...
ScrollOver.prototype = {
  ...
  init: function () {
    ...
    this.toAnimate = this.keyframes.filter(item => {
      return item.animate;
    });
    this.toReveal = this.keyframes.filter(item => {
      return item.reveal;
    });
    this.toRun = this.keyframes.filter(item => {
      return item.run;
    });

    this.toAnimate.forEach(keyframe => {
      if (keyframe) keyframe.animate.forEach(property => {
...
},{"./Scrllr.js":40,"d3-ease":11,"d3-interpolate":17,"d3-scale":23}],42:[function(require,module,exports){
// AnimateScroll.js
...
if (document.querySelectorAll(".recent")[0]) {
